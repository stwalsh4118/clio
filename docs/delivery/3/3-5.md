...
- [ ] Diff extraction service implemented
- [ ] Full commit diff extracted
- [ ] File-level statistics extracted
- [ ] Large diffs handled efficiently
- [ ] Truncation implemented correctly
- [ ] File statistics accurate
- [ ] Diff format correct
...
- `internal/git/diff.go` (new) - Commit diff extraction service
- `internal/git/types.go` (updated) - Add diff-related types
- `internal/git/diff_test.go` (new) - Unit tests for diff extraction
