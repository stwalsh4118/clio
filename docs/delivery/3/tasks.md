...
| 3-7 | [Implement markdown export for commits](./3-7.md) | Proposed | Export commits to markdown files organized by date and project in correct directory structure |
