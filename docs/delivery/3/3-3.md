...
- [ ] Polling configuration added to config
- [ ] Poller service implemented
- [ ] Periodic polling works correctly
- [ ] New commits detected
- [ ] Last seen hash tracked
- [ ] Multiple repositories handled concurrently
