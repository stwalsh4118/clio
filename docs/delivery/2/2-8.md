...
- [ ] Processed conversation tracking in database implemented
- [ ] Incremental parsing works
- [ ] Database update logic implemented
- [ ] New messages inserted correctly
- [ ] Conversation metadata updated correctly
- [ ] Session metadata updated correctly
- [ ] Atomic database updates implemented
- [ ] Edge cases handled
- [ ] Unit tests written and passing
- [ ] State persistence in database works
...
- `internal/cursor/storage.go` (updated) - Add update methods to storage interface
