...
- [ ] Config file is created automatically when missing
- [ ] `~/.clio/` directory is created if needed
- [ ] Default configuration values match PBI PRD schema
...
- `internal/config/loader.go` (updated to call initialization)
