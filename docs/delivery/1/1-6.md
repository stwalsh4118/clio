...
- [ ] Watched directories are validated
- [ ] Blog repository path is validated
- [ ] Storage paths are validated
- [ ] Session configuration is validated
- [ ] Validation errors prevent saving invalid config
- [ ] Validation errors prevent starting daemon
- [ ] Error messages are clear and helpful
- [ ] Optional configuration is handled gracefully
